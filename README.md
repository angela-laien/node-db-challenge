...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      Relational Databases stores data in tables. SQL is the language that write queries to access data in a database table.

- [ ] Why do tables need a `primary key`?
      Primary key identifies data and avoids ambiguity.
